    ...
    def get_outcome(self):
        ...
        for piece in self.pieces:
            if piece.player == 1 and piece.removed:
                ...
                player2_pieces += 1
        if player1_pieces == (GAME_SIZE -1)/2 and self.turn == 1:
            return 1
        elif player2_pieces == (GAME_SIZE-1)/2 and self.turn == 2:
            return -1
        elif player1_pieces == (GAME_SIZE -1)/2 and self.turn == 2:
            return -1
        elif player2_pieces == (GAME_SIZE-1)/2 and self.turn == 1:
            return 1
        else :
            return 0
